...
from bot.db import list_today_events, get_all_chat_ids
...
async def daily_reminder():
    ...
    chat_ids = get_all_chat_ids()  # Функція, яка отримує всі chat_id з бази даних
...
async def send_reminder(chat_id, event_id, name, venue, action, event_datetime, bot):
    ...
    chat_ids = get_all_chat_ids()  # Получаем список всех chat_id

    # Припускаючи, що 'event_datetime' вже в правильному часовому поясі, конвертуємо у формат без часового поясу для виводу
